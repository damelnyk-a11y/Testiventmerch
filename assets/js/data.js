...
const merchData = [
    ...
    {
        id: "REF-019",
        brand: "Off-White x AC Milan",
        year: "2024/25",
        category: "apparel",
        item: "Varsity Jacket",
        idea: "The Varsity Varsity: переосмысление классического американского бомбера через миланский стиль.",
        design: "Огромное количество нашивок с вехами клуба и PIN-UP: география, достижения, 10-летие; фирменная Off-White кавычечная типографика; внешне черная, внутренне ярко-красная подкладка.",
        tech: "Chenille patches,刺绣 [смок], kulit, contrast lining",
        packaging: "Premium box + dust bag",
        price: "premium",
        relevance: "Прямой референс использования красного и черного в премиум-сегменте; идеален для юбилейного флагмана коллекции.",
        takeaways: ["Нашивки-символы: сет патчей на рукавах, отражающий 10-летие PIN-UP.", "Типографика в кавычках: ироничные надписи на спине/груди в стиле Вирджила Абло.", "Красная подкладка: сдержанная внешняя черная сторона + яркий внутренний 'взрыв'."],
        tags: ["football", "collab", "premium", "varsity", "anniversary"],
        vibe: "linear-gradient(45deg, #000000 50%, #c53030 50%)",
        ...createRefMedia("REF-019", []),
        links: ["https://www.off---white.com"]
    },
    {
        id: "REF-020",
        brand: "FC Barcelona x Travis Scott (Cactus Jack)",
        year: "2025",
        category: "apparel",
        item: "Oversized T-Shirt",
        idea: "Desert Sport: гранатово-синие полосы 'Барсы' переплетаются с кактусами, 'грязными' принтами и hand-drawn элементами.",
        design: "Классические цвета Барсы + песочные/темно-коричневые вставки, эффект поношенности, маркерные рисунки цифры 10 и логотипа PIN-UP.",
        tech: "Heavyweight jersey (400g/m2), garment wash, puff/foil print",
        packaging: "Recycled kraft box",
        price: "mid",
        relevance: "Показ, как строгий клубный бренд можно сделать дерзким, желанным для зумеров.",
        takeaways: ["Hand-drawn детали: маркерная графика поверх основной композиции.", "Землистые оттенки: песочные/темно-коричневые вставки рядом с красным.", "Тяжелый оверсайз: плотная ткань со спущенным плечом."],
        tags: ["football", "streetwear", "youth", "oversize"],
        vibe: "linear-gradient(135deg, #1a234f 60%, #c82030 40%)",
        ...createRefMedia("REF-020", []),
        links: ["https://store.fcbarcelona.com"]
    },
    {
        id: "REF-021",
        brand: "BAPE® x Footshop (10th Anniversary)",
        year: "2025",
        category: "apparel",
        item: "Camo Hoodie",
        idea: "Camo Anniversary: легендарный BAPE камуфляж + локальный Footshop, отметка '10' и городские элементы Праги.",
        design: "Custom Camo с замаскированными костями, картами и цифрой 10; текстура с отражающим золотом или светоотражающими вкраплениями.",
        tech: "Custom jacquard camo, reflective thread, embroidered 10",
        packaging: "Collector box + vinyl insert",
        price: "premium",
        relevance: "Кейс для десятилетия: уникальный паттерн связывает два бренда, приближает формат юбилейного дропа.",
        takeaways: ["Custom Camo: паттерн Pin-up Camo с игровыми символами.", "Юбилейный брендинг: золотые/светоотражающие элементы '10 Years'.", "Коллекционный объект: идея non-apparel предмета (виниловый проигрыватель)."],
        tags: ["anniversary", "camo", "collectible", "collab"],
        vibe: "linear-gradient(145deg, #2d2d2d 50%, #c8a92d 50%)",
        ...createRefMedia("REF-021", []),
        links: ["https://www.footshop.com/blog/bape-10th-anniversary"]
    },
    {
        id: "REF-022",
        brand: "Off-White x AC Milan (Suit & Formal)",
        year: "2024",
        category: "apparel",
        item: "Blazer + Trousers",
        idea: "Uniform for Non-Uniformers: строгие пиджаки и брюки с уличными деталями и яркими красными тегами.",
        design: "Классический крой + красные теги на манжетах, тональная чёрная вышивка, брендированные пуговицы и заклепки.",
        tech: "Wool blend suiting, satin sleeve tag, tonal embroidery",
        packaging: "Premium garment bag + branded hanger",
        price: "luxury",
        relevance: "Кейс для официальных мероприятий: выглядеть солидно, сохранив драйв бренда.",
        takeaways: ["Внешние бирки: красная атласная бирка 'Product of Pin-up' на манжете.", "Детализация фурнитуры: брендированные пуговицы/заклепки.", "Тональная вышивка: черный логотип на черном фоне, заметный под углом."],
        tags: ["formal", "heritage", "collab", "luxury"],
        vibe: "linear-gradient(135deg, #0a0a0a 70%, #c53030 30%)",
        ...createRefMedia("REF-022", []),
        links: ["https://www.off---white.com"]
    },
    {
        id: "REF-023",
        brand: "PSG x Walk in Paris",
        year: "2025",
        category: "apparel",
        item: "Lifestyle Hoodie",
        idea: "Retro-Chic & Street: 80-е Парижа после заката в спортивной форме.",
        design: "Велюровые вставки, винтажный патч '10 лет', пастельные акценты на темно-морском фоне, boxy fit.",
        tech: "Velvet paneling, premium cotton, embroidery patch",
        packaging: "Branded kraft box",
        price: "premium",
        relevance: "Мерч 'вне времени', носится и в бар, и на деловую встречу. Идеальный кейс для PIN-UP 10Y lifestyle.",
        takeaways: ["Велюровые вставки для тактильного контраста.", "Ретро патч '10 лет' в стиле теннисного клуба.", "Boxy fit: укороченный, широкий крой."],
        tags: ["football", "lifestyle", "retro", "premium"],
        vibe: "linear-gradient(135deg, #1b2342 60%, #9f8fbb 40%)",
        ...createRefMedia("REF-023", []),
        links: ["https://store.psg.fr/en/c-7925-walk-in-paris"]
    },
    {
        id: "REF-024",
        brand: "iGaming Merch (1win / IGaming Community)",
        year: "2025",
        category: "apparel",
        item: "Cyber Hoodie",
        idea: "Cyber-Punk & Neon High: конференционный мерч для Sigma и iGB.",
        design: "Гигантские принты, рефлективные панели, сетка, массивные карманы для аксессуаров.",
        tech: "Reflective textiles, mesh inserts, modular pockets",
        packaging: "Holographic mailer",
        price: "mid",
        relevance: "Текущий тренд ниши, отражает динамику контента и инфлюенсеров. Мерч должен выделяться на фоне ивентов.",
        takeaways: ["Рефлектив: логотипы вспыхивают на фото.", "Сложный крой с молниями/липучками для патчей.", "Аксессуары: чехлы для наушников, картхолдеры."],
        tags: ["gaming", "event", "neo", "street"],
        vibe: "radial-gradient(circle, #0a0a0a, #0f4f95, #00f0ff)",
        ...createRefMedia("REF-024", []),
        links: ["https://www.instagram.com/igamingmerch/"]
    },
    {
        id: "REF-025",
        brand: "OVO x NBA",
        year: "2025",
        category: "apparel",
        item: "Luxury Varsity Bomber",
        idea: "Luxury Varsity: золото на черном/красном в премиальном спортивном ключе.",
        design: "Дорогие материалы (шерсть, кожа), массивная вышивка, минималистичный эмблемный стиль.",
        tech: "Wool blend, leather shoulder panels, gold embroidery",
        packaging: "Premium collector box",
        price: "luxury",
        relevance: "OVO демонстрирует lifestyle победителя и премиальный мерч 10-летия Pin-up.",
        takeaways: ["Золотая нить: вышивка '2016–2026'.", "Микро-символ Pin-up как сова OVO.", "Satin finish: блеск на бомберах"],
        tags: ["luxury", "sportswear", "legacy"],
        vibe: "linear-gradient(135deg, #000000 60%, #b9972a 40%)",
        ...createRefMedia("REF-025", []),
        links: ["https://us.octobersveryown.com/collections/nba"]
    },
    {
        id: "REF-026",
        brand: "1win Affiliate / Lifestyle Reels",
        year: "2025",
        category: "apparel",
        item: "Reels Hoodie",
        idea: "Influencer Ready: мерч для эффектного видеоконтента.",
        design: "Яркие цвета, динамичные принты, акцент на капюшон, манжеты и шнурки.",
        tech: "Silicone print, contrast drawstrings, dynamic fit",
        packaging: "Branded pouch",
        price: "mid",
        relevance: "Идеален для соцсетей, кликабельных сторис и branded reels.",
        takeaways: ["Contrast drawstrings: яркие шнурки и брендированные наконечники.", "Большой вертикальный принт вдоль рукава штанины.", "Текстурный силиконовый принт на груди."],
        tags: ["social", "content", "streetwear"],
        vibe: "linear-gradient(135deg, #151515 60%, #e82837 40%)",
        ...createRefMedia("REF-026", []),
        links: ["https://www.instagram.com/1winaff/reels/"]
    },
    {
        id: "REF-027",
        brand: "PSG Limited / Jordan Branding",
        year: "2025",
        category: "apparel",
        item: "Performance Tee",
        idea: "Hype Performance: соединение Dri-FIT технологий с уличным хайпом.",
        design: "Геометрия, технологичные ткани, градиент от черного к красному, лимитированная номерная бирка.",
        tech: "Dri-FIT, mesh panels, stitched limited edition label",
        packaging: "Limited edition sleeve",
        price: "premium",
        relevance: "Идеальный пример преобразования спортивного бренда в модный.",
        takeaways: ["Градиент: от глубокого черного к фирменному красному.", "Минималистичные бирки: номер 1/500.", "Формат 'Hype Performance' для уникальности дропа."],
        tags: ["performance", "limited", "football"],
        vibe: "linear-gradient(160deg, #000000 65%, #c53030 35%)",
        ...createRefMedia("REF-027", []),
        links: ["https://store.psg.fr/en/paris-saint-germain-psg-limited/t-92422537+x-86823951+z-87-3637129000"]
    },
    {
        id: "REF-028",
        brand: "Travis Scott x McDonald’s (Fry II T-Shirt)",
        year: "2024",
        category: "apparel",
        item: "Graphic T-Shirt",
        idea: "Pop-Art & Earth Tones: коричневый базис и ироничный фастфуд-принт как коллекционный объект.",
        design: "Earth Brown, ретро-пачка фри, выцветающий шёлкографический принт; визуализация символа азартного мира через картошку фри.",
        tech: "Silk-screen print, garment wash, soft cotton",
        packaging: "Retro kraft bag",
        price: "mid",
        relevance: "URI: мерч-ирония на corporate icon; показывает, как превратить эмблему азартной индустрии в pop-art объект желания.",
        takeaways: ["Нестандартный базовый цвет: шоколадный / темно-песочный / графит.", "Ироничный принт: большой ретро-символ удачи на спине.", "Эффект 90-х: простая шелкография + выцветание."],
        tags: ["ironic", "streetwear", "collab"],
        vibe: "linear-gradient(135deg, #4d351b 65%, #c9ab7e 35%)",
        ...createRefMedia("REF-028", []),
        links: ["https://hypeclothing.com"]
    },
    {
        id: "REF-029",
        brand: "Palace x Stella Artois (PALACE ARTOIS)",
        year: "2024",
        category: "apparel",
        item: "Polo Shirt",
        idea: "Pub Culture Luxury: золотые каймы, глубокий синий, старинная европейская эстетика пивных баров.",
        design: "Гибридный логотип Palace-Artois, классический поло-воротник, винтажные плакаты и аксессуары для бара.",
        tech: "Embroidery, woven label, premium pique",
        packaging: "Golden foil sleeve",
        price: "premium",
        relevance: "Даёт понимание, как PIN-UP / Redcore может сыграть на теме отдыха и азарта; не только одежда, но и lifestyle-аксессуары.",
        takeaways: ["Типографический гибрид: юбилейный логотип под премиум бренд.", "Барные аксессуары: коллаб- бокалы и подставки с гравировкой.", "Европейское ретро: качественный поло, рекламные графики в стиле плакатов."],
        tags: ["drink", "lifestyle", "collab"],
        vibe: "linear-gradient(145deg, #031d44 55%, #dfb24a 45%)",
        ...createRefMedia("REF-029", []),
        links: ["https://www.goat.com"]
    },
    {
        id: "REF-030",
        brand: "OVO x NCAA (Varsity Collection)",
        year: "2025",
        category: "apparel",
        item: "Varsity Bomber",
        idea: "Heritage Athletics: классический американский бомбер с кожаными рукавами и шерстяным корпусом.",
        design: "Массивная chenille-вышивка, архивные эмблемы, 10/16 на плечах, лавровый венок, красно-бело-черная палитра.",
        tech: "Wool body, leather sleeves, chenille patches, embroidered inside message",
        packaging: "Collector box with heritage booklet",
        price: "luxury",
        relevance: "Statement piece для 10-летия: мощный посыл истории, командного духа и успешной эволюции бренда.",
        takeaways: ["Цифры 10 и 16 на плечах объемной chenille.", "Комбинация материалов: матовая кожа + плотное сукно.", "Шивроны/патчи: лавровый венок + Pin-up-элемент, скрытое послание внутри."],
        tags: ["heritage", "varsity", "anniversary"],
